            ...
            {filtered.map((client) => (
              ...
              >
                ...
                <td className="p-4">
                  ...
                  {((client.segment === 'Corporate' || client.segment === 'Institutional') ? ((client as any).contactPhone || client.phone) : client.phone) && <div className="text-xs text-slate-400">{(client.segment === 'Corporate' || client.segment === 'Institutional') ? ((client as any).contactPhone || client.phone) : client.phone}</div>}
                </td>
                <td className="p-4">
      ...
      {showAdd && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-xl p-6 space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            <div>
              <label className="text-xs text-slate-500 block mb-1">客户账户号 *</label>
              <input
                value={addForm.code}
                onChange={e => {
